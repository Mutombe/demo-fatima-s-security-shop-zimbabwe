...
const siteData = {
  business: {
    name: "Fatima's Security Shop Zimbabwe",
    legalName: "Fatima's Security Shop Zimbabwe",
    tagline: "Your One-Stop Security Equipment Shop",
    description: "Fatima's Security Shop Zimbabwe is Belvedere's go-to destination for security equipment, installation, and support. Cameras, alarms, locks, and everything you need to protect what matters.",
    phone: "+263 77 418 7797",
    phoneRaw: "+263774187797",
    whatsappNumber: "263774187797",
    email: "sales@fatimassecurity.co.zw",
    address: "81 Belvedere Rd, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "fatima-s-security-shop-zimbabwe-cookie-consent",
    socialLinks: {
      facebook: "#",
      instagram: "#",
      linkedin: "#",
  ...
  navbar: {
    logoImage: null,
    logoLine1: "Fatima's",
    logoLine2: "Security Shop",
  },

  hero: {
    badge: "Belvedere's Complete Security Equipment Shop",
    titleParts: [
      { text: "EVERYTHING" },
      { text: "SECURITY", highlight: true },
      { text: "UNDER ONE ROOF." },
    ],
    subtitle: "Fatima's Security Shop Zimbabwe is Belvedere's go-to destination for security equipment, installation, and support. Cameras, alarms, locks, and everything you need to protect what matters.",
    ctaPrimary: "Shop Now",
    ctaSecondary: "Installation Services",
    trustBadge: "1000+ Clients Served",
    backgroundImages: [
  ...
  stats: [
    { number: "1000+", label: "Installations Done" },
  ...
  homeTestimonials: [
    { text: "Fatima's Security Shop Zimbabwe installed a complete CCTV system at my home and I finally feel safe. The cameras are crystal clear and I can check my phone from anywhere.", name: "Wellington Moyo", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "We contracted Fatima's Security Shop Zimbabwe for our estate security and they delivered a fully integrated system -- cameras, access control, and electric fencing all working together.", name: "Chenai Dziva", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "Fatima's Security Shop Zimbabwe installed security cameras at our school and the improvement in safety and accountability has been remarkable. Parents are very reassured.", name: "Tapiwa Gondo", role: "School Headmaster", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
    { text: "The alarm system Fatima's Security Shop Zimbabwe installed has already paid for itself. Fast response, reliable monitoring, and their technicians are always available when needed.", name: "Martha Zvobgo", role: "Business Owner, CBD", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
  ],
  ...
  about: {
    ...
    story: [
      "Fatima's Security Shop has been Belvedere Road's trusted security equipment supplier since 2017. We stock, install, and support a comprehensive range of security products.",
      "Over 1,000 customers trust Fatima's for everything from a simple padlock to a complete 32-camera surveillance system. We do not just sell security -- we install it and support it.",
    ],
    values: [
    ...
    team: [
      { name: "Team Leader", role: "Director", bio: "Leading Fatima's Security Shop Zimbabwe with expertise and vision.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
  ...
  reviews: {
    ...
    items: [
      { text: "Fatima's Security Shop Zimbabwe installed a complete CCTV system at my home and I finally feel safe. The cameras are crystal clear and I can check my phone from anywhere.", name: "Wellington Moyo", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "We contracted Fatima's Security Shop Zimbabwe for our estate security and they delivered a fully integrated system -- cameras, access control, and electric fencing all working together.", name: "Chenai Dziva", role: "Property Manager", rating: 5 },
      { text: "Fatima's Security Shop Zimbabwe installed security cameras at our school and the improvement in safety and accountability has been remarkable. Parents are very reassured.", name: "Tapiwa Gondo", role: "School Headmaster", rating: 5 },
      { text: "The alarm system Fatima's Security Shop Zimbabwe installed has already paid for itself. Fast response, reliable monitoring, and their technicians are always available when needed.", name: "Martha Zvobgo", role: "Business Owner, CBD", rating: 5 },
      { text: "Remote viewing works perfectly. I can see my house from my office phone thanks to Fatima's Security Shop Zimbabwe's CCTV setup.", name: "Simba Karonga", role: "Remote Monitoring Client", rating: 5 },
      { text: "Electric fence installation was done in one day with minimal disruption. Fatima's Security Shop Zimbabwe are efficient and tidy.", name: "Douglas Mhizha", role: "Homeowner", rating: 5 },
      { text: "The access control system Fatima's Security Shop Zimbabwe installed at our offices has completely eliminated unauthorised entry.", name: "Linda Masuku", role: "Corporate Client", rating: 5 },
      { text: "Night vision on these cameras is incredible. Fatima's Security Shop Zimbabwe recommended the right specs for our needs.", name: "Patrick Makoni", role: "Night Security Client", rating: 5 },
      ...
      { text: "Annual maintenance contract with Fatima's Security Shop Zimbabwe keeps everything working perfectly. Proactive, not reactive.", name: "Brian Mutema", role: "Maintenance Client", rating: 5 },
    ],
  },
  ...
  contact: {
    ...
    branches: [
      { name: "Main Office", address: "81 Belvedere Rd, Harare, Zimbabwe", phone: "+263 77 418 7797", email: "sales@fatimassecurity.co.zw" },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hello Fatima's! I need security equipment.",
    backgroundImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1920&q=85",
  },

  footer: {
    description: "Fatima's Security Shop Zimbabwe is Belvedere's go-to destination for security equipment, installation, and support. Came...",
    copyright: "Fatima's Security Shop Zimbabwe",
  },
};
